...
async def ask_question(
    ...
    try:
        ...
        # Check for net revenue specifically
        question_lower = request.question.lower()
        is_net_revenue = any(kw in question_lower for kw in ['net revenue', 'net profit', 'after refunds', 'net earnings'])
        ...
        if intent.type == "METRIC":
            ...
            if is_net_revenue:
                query_result = query_net_revenue(start_date, end_date)
            else:
                query_result = execute_metric_query(intent, start_date, end_date)
